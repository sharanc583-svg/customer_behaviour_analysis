...
SELECT item_purchased,
       ROUND(AVG(CAST(review_rating AS DECIMAL(10,2))), 2) AS "Avg Product Rating"
FROM customer_behaviour
...
select shipping_type, ROUND(AVG(CAST(purchase_amount AS DECIMAL(10,2))), 2) as purchase_amount
from customer_behaviour
